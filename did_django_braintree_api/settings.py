"""
Django settings for did_django_braintree_api project.
...
SECRET_KEY = '7xt63!5m+cm36v$$_e88(#$=(6vl%=07$u-vt_*+txpk^3#u&9'
...
ROOT_URLCONF = 'did_django_braintree_api.urls'
...
WSGI_APPLICATION = 'did_django_braintree_api.wsgi.application'
